...
Ext.define('cvges.Application', {
			...
			launch : function() {
				...
				// It's important to note that this type of application could
				// use
				...
				if (!supportsLocalStorage) {
					...
					// Alert the user if the browser does not support
					// localStorage
				...
				// This ternary operator determines the value of the
				// TutorialLoggedIn key.
